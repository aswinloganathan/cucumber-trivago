Feature: To plan for a vacation

  Scenario: Book hotels, travel mode and place
    Given Launch the Browser
    And Load the URL https://www.trivago.com/
    ...
    And Choose Number of Adults 2, Childern 1 and set Child Age as 4
